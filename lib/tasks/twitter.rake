namespace :twitter do
  ...
  task :get_followers_count => :environment do
    ...
    new_models << Follower.new(
      team_id: 131,
      followers_count: client.user(172146029).followers_count,
    )
    new_models << Follower.new(
      team_id: 141,
      followers_count: client.user(135344564).followers_count,
    )
    new_models << Follower.new(
      team_id: 151,
      followers_count: client.user(3311064974).followers_count,
    )
    new_models << Follower.new(
      team_id: 161,
      followers_count: client.user(3300129186).followers_count,
    )
    new_models << Follower.new(
      team_id: 171,
      followers_count: client.user(737150290965581829).followers_count,
    )
